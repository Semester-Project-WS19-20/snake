...
void snake_apple_collision_detect(snake_actor *sn)
{
    ...
    if (snake_head->r[0] == eng.apple_actor.sprite.r[0] && snake_head->r[1] == eng.apple_actor.sprite.r[1])
    {
        ...
        float seconds_per_update = INITIAL_SNAKE_SECONDS_PER_UPDATE - (float)eng.score * SNAKE_SECONDS_PER_UPDATE_INCREMENT;
